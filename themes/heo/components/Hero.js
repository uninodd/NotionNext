  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          'rounded-xl overflow-hidden opacity-0 group-hover:opacity-100 duration-300 transition-all bg-[#0d2b7d96] dark:bg-[#ca8a048f] dark:text-white cursor-pointer absolute w-full h-full top-0 flex justify-start items-center'
        }
      >
        <div className="ml-12 -translate-x-32 group-hover:translate-x-0 duration-300 transition-all ease-in">
          <div className="text-7xl text-white font-extrabold">立即前往</div>
      ...
      <div
        ...
        className={`${
          isCoverUp
            ...
            : 'opacity-0 transform scale-120 pointer-events-none'
        } shadow transition-all duration-180 today-card h-full bg-[#36547d] rounded-xl relative overflow-hidden flex items-end`}
      >
        <div
          id="today-card-info"
        ...
        >
          ...
          <div 
            ...
            } flex items-center px-3 h-10 justify-center bg-[#0E57D5] hover:bg-[#0d2b7d96] transition-colors duration-100 rounded-3xl`}
          >
            <PlusSmall
