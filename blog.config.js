...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'uninodd', // 您的昵称 例如 tangly1024
  ...
  // artalk 评论插件
  COMMENT_ARTALK_SERVER: process.env.NEXT_PUBLIC_COMMENT_ARTALK_SERVER || 'false', // ArtalkServert后端地址 https://artalk.js.org/guide/deploy.html
